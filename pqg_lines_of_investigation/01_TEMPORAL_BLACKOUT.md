...
A search of the complete concordance database (`concordance_complete.db`, 1,385,519 documents) for records dated within the gap period (July 2017 through December 2018) yields only six results, all from the House Oversight collection (Epstein's personal email archive):
